/**
 * @file 	v3_warpPerspective.cpp， 对应与可执行文件 v3_warpPerspective
 * @brief 	顶点跟踪，透视变换.主要涉及透视变换和旋转
...
int main()
{
   std::cout << "【v3_warpPerspective】 is running ……" << std::endl;
